...
namespace DrawerLayout_V7_Tutorial
{
    ...
    class MainActivity1: Activity
    {
        ...
        private bool ValidateLogin()
        {
            ...
            ProgressDialog progress = ProgressDialog.Show(this.Activity, "", "Loading...");
            ...
            if (string.IsNullOrEmpty(security.token) || user!= username.Text || password.Text!=passwd)
            {
                valid = false;
                username.Error = "Please enter correct username";
                return valid;
            }
            else
            {
