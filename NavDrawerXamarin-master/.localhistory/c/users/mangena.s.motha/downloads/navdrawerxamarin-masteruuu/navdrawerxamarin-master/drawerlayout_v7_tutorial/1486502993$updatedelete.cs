...
namespace DrawerLayout_V7_Tutorial
{
    ...
    public class UpdateDelete : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            try
            {
                userDetails = (UserClass)Intent.GetSerializableExtra("user");
                ...
                //var results = service.GET("http://userservice.staging.tangentmicroservices.com:80/api/v1/users/\"" + userId+"\"", security.token);
