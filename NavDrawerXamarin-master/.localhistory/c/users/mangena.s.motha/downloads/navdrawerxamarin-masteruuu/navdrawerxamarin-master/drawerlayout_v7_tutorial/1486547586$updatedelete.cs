...
namespace DrawerLayout_V7_Tutorial
{
    ...
    public class UpdateDelete : Activity
    {
        ...
        private void updateClicked(object sender, EventArgs e)
        {
            ...
            {
                Toast.MakeText(this, userDetails.first_name + "User's information was updated", ToastLength.Short).Show();
                Finish();
            }
            else
            {
                Toast.MakeText(this, userDetails.first_name + "Something went wrong . Please try again later.", ToastLength.Short).Show();
            }
            progress.Dismiss();
        }
        ...
        private void deleteClicked(object sender, EventArgs e)
        {
            ...
            if (results)
            {
                Toast.MakeText(this, "User have been deleted", ToastLength.Short).Show();
                this.Finish();
            }
            else
            {
