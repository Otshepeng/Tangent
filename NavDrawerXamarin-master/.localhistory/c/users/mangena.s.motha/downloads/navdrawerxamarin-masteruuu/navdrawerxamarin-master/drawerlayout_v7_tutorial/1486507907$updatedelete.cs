...
namespace DrawerLayout_V7_Tutorial
{
    ...
    public class UpdateDelete : Activity
    {
        ...
        private void updateClicked(object sender, EventArgs e)
        {
            ...
            \
            var results = service.PUT("http://userservice.staging.tangentmicroservices.com:80/api/v1/users/\"" + userDetails.id + "/\"", " {\"id\": 10,\"first_name\": \"zoro\",\"last_name\": \"wali\",\"username\": \"jamesmwali\",\"email\": \"jamessmwali@gmail.com\"}", security.token);
